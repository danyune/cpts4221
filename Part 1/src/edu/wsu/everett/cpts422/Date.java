...
public class Date {
	...
	public String toString() {
		return dd + "/" + mm + "/" + yyyy + ", is the " + dayNumber + " of the year and the zodiac sign is "
				+ zodiacSign;
	}
	...
	public static boolean validCombination(int thisDay, int thisMonth, int thisYear) {
		if ((thisDay == 31)
				&& ((thisMonth == 2) || (thisMonth == 4) || (thisMonth == 6) || (thisMonth == 8) || (thisDay == 11))) {
	...
	// Century years are leap years only if they are multiples of 400 (Inglis,
	// 1961);
	...
	// 31 28 31 30 31 30 31 30 30 31 29 31
